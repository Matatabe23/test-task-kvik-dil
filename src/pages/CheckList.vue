<template>
	<div class="checkList">
		...
		<ListTasks :waiting="Waiting" @deleteTask="deleteTask" @startEdit="startEdit" @updateTask="updateTask"></ListTasks>
		<editWindows :editedTask="editedTask" :editingTask="editingTask" @saveEdit="saveEdit" @cancelEdit="cancelEdit">
		</editWindows>
	</div>
</template>
